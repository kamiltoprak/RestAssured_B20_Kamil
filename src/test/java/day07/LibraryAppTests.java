...
import day03.practices.JasonPath;
...
//      this is how we provide header .header("headerName","headerValue")
    ...
    @Test
    public void testGetDashBoardStartAsMap(){
    ...
    @DisplayName("4.Save/get_book_categories_As_POJO")
    @Test
    public void testGetBookCategoriesAsPOJO(){
        ...
        // use jsonpath to get number 5  item in json  array
