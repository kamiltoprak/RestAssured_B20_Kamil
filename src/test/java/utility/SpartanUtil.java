...
public class SpartanUtil {
    ...
    public static Map<String, Object> getRandomSpartanRequestPayload(){
        ...
        paylaodMap.put("name",faker.name().firstName());
        paylaodMap.put("gender",faker.demographic().sex());
        paylaodMap.put("phone",faker.number().numberBetween(5000000000L,10000000000L));
